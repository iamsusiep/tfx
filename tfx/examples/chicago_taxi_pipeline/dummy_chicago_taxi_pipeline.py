...
from tfx.experimental.dummy_executor import  make_dummy_executor #DummyExecutorFactory,
...
if __name__ == '__main__':
  ...
  mock_pipeline.set_dummy_executor('CsvExampleGen', make_dummy_executor('CsvExampleGen', record_dir))
